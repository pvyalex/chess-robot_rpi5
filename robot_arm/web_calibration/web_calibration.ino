...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">Control Robot Remote</h1>
    <h2 style="color: teal;text-align:center;">Paven Nica Morosanu Safta</h2>
...
void playRecordedRobotArmSteps()
{
  ...
  // Move servos to initial position slowly. First N steps are initial positions.
  for (int i = 0; i < (int)servoPins.size() && playRecordedSteps; i++)
  {
  ...
  delay(2000); // Delay before starting actual recorded steps.
  
  for (int i = (int)servoPins.size(); i < (int)recordedSteps.size() && playRecordedSteps ; i++)
  {
    RecordedStep &recordedStep = recordedSteps[i];
